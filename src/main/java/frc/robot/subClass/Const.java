...
public class Const {
    ...
    public static final Gains kGains_AutoDriveStraight = new Gains(0.0875, 0.00003 * 2, 0.1 * 2.2, 0, 0, 0.7, 0.0);
    public static final Gains kGains_AutoDriveTurn = new Gains(1 , 0, 0.9 , 0, 0, 0.6, 0.0);
